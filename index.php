...
$sqldoinma="SELECT * FROM post1";
$sqlkn=$conn->prepare($sqldoinma);
$sqlkn->execute();
$voide1=$sqlkn->fetchAll();

$sqldoinma1="SELECT * FROM post2";
$sqlkn1=$conn->prepare($sqldoinma1);
$sqlkn1->execute();
$voide11=$sqlkn1->fetchAll();
?>
<!DOCTYPE html>
<html lang="en">
...
<head>
    ...
    <link href="./publicindex/css/bootstrap.min.css" rel="stylesheet">

    <!-- Template Stylesheet -->
    <link href="./publicindex/css/style.css" rel="stylesheet">
</head>
...
<body>
    <div class="container-xxl bg-white p-0">
            ...
            <div class="container-xxl py-5 bg-primary hero-header mb-5">
                <div class="container my-5 py-5 px-lg-5">
                    <div class="row g-5 py-5">
                        <?php foreach ($voide1 as $key => $value):?>
                        <div class="col-lg-6 text-center text-lg-start">
                            <h1 class="text-white mb-4 animated zoomIn">
                                <?=$value['text1']?></h1>
                            <p class="text-white pb-3 animated zoomIn"><?=$value['text2']?></p>
                        ...
                        <?php endforeach; ?>
                        <div class="col-lg-6 text-center text-lg-start">
                            <img class="img-fluid" src="uploads/<?=$value['img4']?>" alt="">
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="container-xxl py-5">
            <div class="container px-lg-5">
                <div class="row g-5">
                    <?php foreach ($voide11 as $key => $value): ?>
                    <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.1s">
                        ...
                        <p class="mb-4">
                            ...
                            < /p>
                                <div class="row g-3">
                                    <div class="col-sm-6">
                                        <h6 class="mb-3"><i class="fa fa-check text-primary me-2"></i>Award Winning
                                        </h6>
                                        <h6 class="mb-0"><i class="fa fa-check text-primary me-2"></i>Professional
                                            Staff
                                        </h6>
                                    </div>
                                    <div class="col-sm-6">
                                        <h6 class="mb-3"><i class="fa fa-check text-primary me-2"></i>24/7 Support
                                        </h6>
                                        <h6 class="mb-0"><i class="fa fa-check text-primary me-2"></i>Fair Prices
                                        </h6>
                                    </div>
                                </div>
                    ...
                    <div class="col-lg-6">
                        <img class="img-fluid wow zoomIn" data-wow-delay="0.5s" src="uploads/<?=$value['img3']?>">
                    </div>
                    <?php endforeach?>
                </div>
    ...
    <!-- Template Javascript -->
    <script src="./publicindex/js/main.js"></script>
</body>
